...
Hey Guys ❤, we DSC GGV has conducted the [Hacktober Fest-2020](https://hacktoberfest.digitalocean.com/). So still if you have any Projects regarding Cloud & DevOps based technology or you want to modify/resolve(any bugs) of previous Projects then you have to follow the [Contribution Guidelines](#Contribution-Guidelines).
...
- You can add your own Cloud & DevOps Based Projects.
